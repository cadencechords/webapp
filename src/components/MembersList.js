...
export default function MembersList() {
	...
	const memberCards = members.map((member) => <MemberCard key={member.id} member={member} />);
	return (
		<>
...
const members = [
	{
		...
		first_name: "Tayeesa",
		last_name: "Sidorchuk",
		email: "tayeesasidorchuk@gmail.com",
		position: "Violinist",
		admin: true,
	},
	{
