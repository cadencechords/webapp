...
export default function OutlinedInput({
	...
	return (
		<>
			...
			<div className="flex">
				<input
					className={`transition-all px-3 py-2 shadow-sm border-gray-300 focus:outline-none outline-none w-full border ${roundedClasses} focus:ring-inset focus:ring-2 focus:ring-blue-400`}
