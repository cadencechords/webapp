        ...
        <div className="px-3 py-6">
          <div className="mb-3">
            <Toggle
              ...
              onChange={newEnabledValue =>
                onFormatChange('bold_chords', newEnabledValue)
              }
            />
          </div>
          <div className="mb-5">
            <Toggle
              ...
              onChange={newEnabledValue =>
                onFormatChange('italic_chords', newEnabledValue)
              }
            />
          </div>
          <div className="mb-3">
            <div className="flex-between">
              ...
              <ColorPicker
                ...
                onChange={newChordColor =>
                  onFormatChange('chord_color', newChordColor)
                }
              />
            </div>
          </div>
          ...
          <div className="flex-between">
            ...
            <ColorPicker
              ...
              onChange={newHighlightColor =>
                onFormatChange('highlight_color', newHighlightColor)
              }
            />
          </div>
        </div>
