...
export default function SetlistRow({ setlist }) {
  return (
    <Link
      ...
      className="flex flex-col justify-center h-16 px-3 border-b sm:rounded-lg sm:hover:bg-gray-100 sm:dark:hover:bg-dark-gray-800 dark:border-dark-gray-600 last:border-0 sm:border-0"
    >
