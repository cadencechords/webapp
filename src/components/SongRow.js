...
export default function SongRow({ song }) {
  return (
    <Link
      ...
      className="flex items-center h-12 px-3 border-b sm:rounded-lg sm:h-10 sm:hover:bg-gray-100 dark:hover:bg-dark-gray-800 dark:border-dark-gray-600 last:border-0 sm:border-0"
    >
