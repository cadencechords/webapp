...
export default function RolePermissions({ role, permissions, onPermissionToggled }) {
		...
		<div>
			...
			<div>
				<Permission
					...
					onChange={(checkedValue) => handlePermissionToggled("Add songs", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Edit songs", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Delete songs", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("View songs", checkedValue)}
				/>
			</div>
			...
			<div>
				<Permission
					...
					onChange={(checkedValue) => handlePermissionToggled("Add binders", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Edit binders", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Delete binders", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("View binders", checkedValue)}
				/>
			</div>
			...
			<div>
				<Permission
					...
					onChange={(checkedValue) => handlePermissionToggled("Add sets", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Edit sets", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Delete sets", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("View sets", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Publish sets", checkedValue)}
				/>
			</div>
			...
			<div>
				<Permission
					...
					onChange={(checkedValue) => handlePermissionToggled("Add roles", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Edit roles", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Delete roles", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("View roles", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
					...
					onChange={(checkedValue) => handlePermissionToggled("Assign roles", checkedValue)}
				/>
			</div>
			...
			<div>
				<Permission
					...
					onChange={(checkedValue) => handlePermissionToggled("Add members", checkedValue)}
				/>
				<Permission
					checkable={currentMember.can(EDIT_ROLES) && !(role?.is_admin || role?.is_member)}
