// Material Symbols Rounded (weight 400) used by the app. Only icons listed
// here are bundled. To add one, import it below and add it to ICONS.
...
import AddCircle from '@material-symbols/svg-400/rounded/add_circle.svg?react';
import AddCircleFilled from '@material-symbols/svg-400/rounded/add_circle-fill.svg?react';
import ArrowBack from '@material-symbols/svg-400/rounded/arrow_back.svg?react';
import ArrowForward from '@material-symbols/svg-400/rounded/arrow_forward.svg?react';
import BarChartFilled from '@material-symbols/svg-400/rounded/bar_chart-fill.svg?react';
import CalendarMonth from '@material-symbols/svg-400/rounded/calendar_month.svg?react';
import CalendarMonthFilled from '@material-symbols/svg-400/rounded/calendar_month-fill.svg?react';
import Cancel from '@material-symbols/svg-400/rounded/cancel.svg?react';
import CancelFilled from '@material-symbols/svg-400/rounded/cancel-fill.svg?react';
import Chat from '@material-symbols/svg-400/rounded/chat.svg?react';
import Check from '@material-symbols/svg-400/rounded/check.svg?react';
import CheckFilled from '@material-symbols/svg-400/rounded/check-fill.svg?react';
import CheckCircle from '@material-symbols/svg-400/rounded/check_circle.svg?react';
import CheckCircleFilled from '@material-symbols/svg-400/rounded/check_circle-fill.svg?react';
...
export const ICONS = {
  ...
  'add_circle-fill': AddCircleFilled,
  arrow_back: ArrowBack,
  arrow_forward: ArrowForward,
  'bar_chart-fill': BarChartFilled,
  calendar_month: CalendarMonth,
  'calendar_month-fill': CalendarMonthFilled,
  cancel: Cancel,
  'cancel-fill': CancelFilled,
  chat: Chat,
  check: Check,
  'check-fill': CheckFilled,
  check_circle: CheckCircle,
  'check_circle-fill': CheckCircleFilled,
