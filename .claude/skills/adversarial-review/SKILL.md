...
| **Tests & CI**  | Would CI reject this? Do the tests actually exercise the claim, or pass vacuously? Were errors hidden rather than fixed: `@ts-ignore`, `@ts-expect-error`, `any`, new ESLint suppressions, `test.skip`, loosened assertions? Is anything important untested?           |
